...
export const metadata: Metadata = {
  ...
  description: "Experience authentic Italian cuisine at Bella Vista. Traditional recipes, finest ingredients, and warm hospitality since 1952. Reserve your table today.",
  keywords: "Italian restaurant, authentic Italian food, pasta, pizza, fine dining, reservations",
  metadataBase: new URL("https://bellavista.example.com"),
  alternates: {
    canonical: "https://bellavista.example.com"
  },
  openGraph: {
    title: "Bella Vista - Authentic Italian Restaurant",
    description: "Experience authentic Italian cuisine with traditional recipes passed down through generations",
    ...
    images: [
      {
        ...
        alt: "Bella Vista Italian Restaurant interior"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Bella Vista - Authentic Italian Restaurant",
    description: "Traditional Italian cuisine with the finest ingredients since 1952",
